...
function shiftnav_menu_item_settings(){
	...
	*/
	...
	$settings['general'][10] = array(
		'id' 		=> 'disable_link',
		'title'		=> __( 'Disable Link', 'reign' ),
		'type'		=> 'checkbox',
		'default' 	=> 'off',
		'desc'		=> __( 'Check this box to remove the link from this item; clicking a disabled link will not result in any URL being followed.  Instead, this item will act as a toggle for its submenu, if one exists.' , 'reign' ),
	);

	$settings['general'][20] = array(
		'id' 		=> 'highlight',
		'title'		=> __( 'Highlight Link', 'reign' ),
		'type'		=> 'checkbox',
		'default' 	=> 'off',
		'desc'		=> __( 'Highlight this menu item' , 'reign' ),
	);
	...
	$settings['general'][40] = array(
		'id' 		=> 'scrollto',
		'title'		=> __( 'Scroll To' , 'reign' ),
		'type'		=> 'text',
		'default' 	=> '',
		'desc'		=> __( 'The selector for an item to scroll to when clicked, if present.  Example: <code>#section-1</code>', 'reign' )
	);

	$settings['general'][42] = array(
		'id' 		=> 'disable_current',
		'title'		=> __( 'Disable Current' , 'reign' ),
		'type'		=> 'checkbox',
		'default' 	=> 'off',
		'desc'		=> __( 'Disable the current menu item classes for this item', 'reign' )
	);

	$settings['general'][80] = array(
		'id' 		=> 'disable_item',
		'title'		=> __( 'Disable Item', 'reign' ),
		'type'		=> 'checkbox',
		'default' 	=> 'off',
		'desc'		=> __( 'Hide this item.  Useful if this menu is being reused in multiple locations, but item should not be displayed in ShiftNav', 'reign' ),
	);
	...
	*/
	...
	$settings['submenu'][20] = array(
		...
		'type'		=> 'select',
		'default'	=> 'default',
		'desc'		=> __( '[Requires Pro Version] Overrides the default submenu type.  For the Lite version, only "Always visible" is available.  Can be changed to "Accordion" or "Shift" with the Pro version.' , 'reign' ),
		'ops'		=> array(
  ...
  $settings['submenu'][40] = array(
		'id' 		=> 'disable_submenu',
		'title'		=> __( 'Disable Submenu', 'reign' ),
		'type'		=> 'checkbox',
		'default'	=> 'off',
		'desc'		=> __( 'Disable the submenu for this menu item within ShiftNav.' , 'reign' ),
