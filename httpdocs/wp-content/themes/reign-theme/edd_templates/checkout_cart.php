			...
			<?php foreach ( $cart_items as $key => $item ) : ?>
				<tr class="edd_cart_item" id="edd_cart_item_<?php echo esc_attr( $key ) . '_' . esc_attr( $item['id'] ); ?>" data-download-id="<?php echo esc_attr( $item['id'] ); ?>">
					...
					<td class="edd_cart_actions">
						...
						<a class="edd_cart_remove_item_btn" href="<?php echo esc_url( wp_nonce_url( edd_remove_item_url( $key ), 'edd-remove-from-cart-' . $key, 'edd_remove_from_cart_nonce' ) ); ?>"><i class="fa fa-close"></i><?php //_e( 'Remove', 'easy-digital-downloads' ); ?></a>
					</td>
				...
				<tr class="edd_cart_fee" id="edd_cart_fee_<?php echo $fee_id; ?>">
					...
					<td>
						<?php if( ! empty( $fee['type'] ) && 'item' == $fee['type'] ) : ?>
							<a href="<?php echo esc_url( edd_remove_cart_fee_url( $fee_id ) ); ?>"><i class="fa fa-close"></i><?php //_e( 'Remove', 'easy-digital-downloads' ); ?></a>
						<?php endif; ?>
