<?php
namespace WbcomElementorAddons\Modules\WooCart\Widgets;
...
class WooCart extends Widget_Base {
	...
	protected function render() {
		...
		if( empty( $settings['link']['url'] ) ) {
			$settings['link']['url'] = wc_get_cart_url();
		}
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<span class="wb-cart-count">
				<?php echo ( !is_admin() ) ? WC()->cart->get_cart_contents_count() : '0'; ?>
			</span>
	...
	protected function _content_template() {
		...
		<div class="elementor-icon-wrapper">
			<span class="wb-cart-count">0</span>
