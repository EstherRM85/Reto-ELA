	...
	<div class="supsystic-item supsystic-panel">
		<div id="containerWrapper">
			...
			<div id="cfsFormContactsTblEmptyMsg" style="display: none;">
				<h3><?php _e('You have no Contacts for now. When your visitors start submit your created Contact Fomrs, and if you enabled "Save contacts data" for them - their contacts will be displayed here.', CFS_LANG_CODE)?></h3>
			</div>
		</div>
		<div style="clear: both;"></div>
	</div>
...
<div id="cfsFormContactViewWnd" style="display: none;" title="<?php _e('Contact Details', CFS_LANG_CODE)?>">
	...
	<div id="cfsFormContactFieldRowEx" class="row">
		<div class="col-sm-4 cfsFieldLabel"></div>
		<div class="col-sm-8 cfsFieldValue"></div>
	</div>
</div>